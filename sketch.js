...
function setup() {
  ...
  let b1 = new Button(weight / 3, height / 3, 200, 80, color(226, 132, 19), color(244, 190, 124), arcadeRetroSong);
  let b2 = new Button(weight / 2, height / 3, 200, 80, color(0, 159, 183), color(153, 241, 255), barking);
  let b3 = new Button(2 * weight / 3, height / 3, 200, 80, color(145, 145, 233), color(204, 204, 245), fastPunch);
  ...
  let b7 = new Button(weight / 3, 2 * height / 3, 200, 80, color(255, 163, 175), color(255, 214, 220), toyWhistle);
  let b8 = new Button(weight / 2, 2 * height / 3, 200, 80, color(143, 45, 86), color(216, 131, 166), transition);
  let b9 = new Button(2 * weight / 3, 2 * height / 3, 200, 80, color(236, 78, 32), color(234, 162, 133), whoosh);
